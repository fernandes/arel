  ...
  describe "equality" do
    ...
    describe "backwards compat" do
      describe "operator" do
        it "returns :==" do
          attr = Arel::Nodes::Table.new(:users)[:id]
          left  = attr.eq(10)
    ...
    it "is equal with equal ivars" do
      array = [Arel::Nodes::Equality.new("foo", "bar"), Arel::Nodes::Equality.new("foo", "bar")]
      assert_equal 1, array.uniq.size
    end

    it "is not equal with different ivars" do
      array = [Arel::Nodes::Equality.new("foo", "bar"), Arel::Nodes::Equality.new("foo", "baz")]
